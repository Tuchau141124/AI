...
def load_model_and_tokenizer():
    ...
    model_file_id = "18ggWTH0ysQJuIy9A4pEGYHFsiMM-c0x9"  # Thay bằng Google Drive file ID của bạn
    tokenizer_file_id = "1mZ00amFRXgfKvL1hITbPDPrsGykz2bI6"  # Thay bằng Google Drive file ID của tokenizer
